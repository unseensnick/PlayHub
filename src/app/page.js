...
const games = [
    {
        ...
        description: "The timeless classic game of strategy and chance. Battle against the computer in this best-of-5 showdown.",
        icon: Mountain,
        players: "1 Player",
        duration: "2-5 min",
        difficulty: "Easy",
    ...
    },
    {
        id: "tic-tac-toe",
        title: "Tic Tac Toe",
        description: "Classic 3x3 grid strategy game. Get three in a row to win against your opponent.",
        icon: Zap,
        players: "1-2 Players", 
        duration: "1-3 min",
        difficulty: "Easy",
...
function GameCard({ game }) {
    ...
    return (
        <Card className={`group transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg bg-card/50 backdrop-blur-sm ${
...
export default function Home() {
    const availableGamesCount = games.filter(game => game.status === 'available').length;
            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="text-center mb-16 space-y-6">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Discover a world of fun with our collection of classic and modern minigames. 
                        Perfect for quick breaks or extended gaming sessions.
                    </p>
                    
                    {/* Stats */}
                    <div className="flex justify-center gap-8 text-center">
                        <div className="space-y-1">
                            <div className="text-2xl font-bold text-primary">{availableGamesCount}</div>
                            <div className="text-sm text-muted-foreground">Available</div>
                        </div>
                        <div className="space-y-1">
                            <div className="text-2xl font-bold text-muted-foreground">{totalGamesCount}</div>
